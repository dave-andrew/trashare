  ...
  return (
    <Pressable
      ...
      <Image
        ...
        source={{ uri: queue.orderer?.profileUrl ? queue.orderer.profileUrl : "https://firebasestorage.googleapis.com/v0/b/trashare-3a2a9.appspot.com/o/default-user.png?alt=media&token=7db015cf-943d-42fe-8370-744febfcee8a" }} />

      <View className="flex flex-row justify-between flex-grow">
        <View className="flex flex-col justify-between">
          <Text className="font-medium">{queue?.orderer?.username}</Text>
